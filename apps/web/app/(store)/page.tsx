      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-14 px-6">
        ...
        <div className="flex items-center justify-center flex-col md:text-left w-full max-w-md space-y-6">
          ...
          <div ref={buttonRef} className="relative inline-block">
            <Link href="/products">
              <button
                className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-gray-300 bg-white px-6 py-3 text-gray-800 transition-all duration-200 hover:bg-gray-100"
              >
                <span>→</span> Shop Now
              </button>
            </Link>
