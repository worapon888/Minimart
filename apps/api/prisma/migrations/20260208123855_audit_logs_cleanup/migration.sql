/*
  ...
  - The values [PENDING,FAILED] on the enum `ApiAuditStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ApiAuditStatus_new" AS ENUM ('SUCCESS', 'FAIL');
